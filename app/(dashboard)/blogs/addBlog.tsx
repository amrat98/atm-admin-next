...
const FormSchema = z.object({
  ...
  export function AddBlog({table}: { table: Table<z.infer<typeof recentUserSchema>>}){
  ...
  useEffect(() => {
    ...
    const onSubmit = async (formData: z.infer<typeof FormSchema>) => {
        ...
        try {
            ...
            const response = await axios.post(apiConfig.blogs.add, data, { headers: { token } })

            toast.success(response.data?.responseMessage || "Blog added successfully!");
      ...
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        ...
        <SheetContent className="overflow-auto">
          <SheetHeader>
            ...
            <SheetDescription>Fill the form to create a new blog entry.</SheetDescription>
          </SheetHeader>
          <Form {...form}>
