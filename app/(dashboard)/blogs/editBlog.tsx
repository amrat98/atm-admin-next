...
const FormSchema = z.object({
  ...
  redirectionLink: z.string().url("Enter a valid link"),
  status: z.string(),
  thumbnail: z
  .any()
  .optional()
...
export function EditBlog({row,table}: { row: Row<z.infer<typeof recentUserSchema>>; table: Table<z.infer<typeof recentUserSchema>>;}){
  ...
  useEffect(() => {
    ...
    const onSubmit = async (formData: z.infer<typeof FormSchema>) => {
      ...
      const response = await axios.post(apiConfig.blogs.update, updatedData, {
        headers: { token },
      });

            toast.success(response.data?.responseMessage || "Blog Updated successfully!");
      ...
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        ...
        <SheetContent className="overflow-auto">
          <SheetHeader>
            ...
            <SheetDescription>Edit the form to edit a blog detail.</SheetDescription>
          </SheetHeader>
          <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <FormField
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <Input id="title" type="text" placeholder="Title" {...field} className="text-sm h-10" />
                    </FormControl>
                    <FormMessage />
                    </FormItem>
                )}
            ...
            <FormField
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                      <Textarea id="shortDescription" placeholder="Description" {...field} className="text-sm" />
                    </FormControl>
                    <FormMessage />
                    </FormItem>
                )}
