  ...
  return (
    ...
    <Dialog open={openApprove} onOpenChange={setOpenApprove}>
      <DialogTrigger asChild>
          ...
          {submitting || openApprove ? (<Loader2 className="w-4 h-4 animate-spin" />) : (<Check className="w-4 h-4" />)}
            <span>Approve</span>
          </Button>
      </DialogTrigger>
    ...
    {submitting || openReject ? (<Loader2 className="w-4 h-4 animate-spin" />) : (<X className="w-4 h-4" />)}
      <span>Reject</span>
    </Button>
    </DialogTrigger>
    ...
    <DialogContent showCloseButton={false} onInteractOutside={(e) => {e.preventDefault();}} onEscapeKeyDown={(e) => e.preventDefault()}>
      ...
      <DialogFooter>
        ...
        {/* <DialogClose className="text-sm" disabled={submitting}>Cancel</DialogClose> */}
        <Button
          className="text-sm"
          disabled={submitting}
          onClick={async () => {
